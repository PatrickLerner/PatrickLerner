...
`
  ...
  }, [currentLineIndex, currentCharIndex, terminalContent.length])
    ...
    <div className="terminal-container">
      <div className="terminal">
        ...
        <div className="terminal-body">
          <pre className="ascii-art" style={{ color: '#8fbcbb' }}>{asciiArt}</pre>
          
          {terminalContent.map((line, index) => {
            if (index > displayedLines) return null

            if (line.type === 'command') {
              const displayText = index === currentLineIndex 
              ...
              return index <= displayedLines ? (
                <div key={index} className="terminal-line">
                  <span className="output" style={{ whiteSpace: 'pre-wrap' }}>{line.text}</span>
                </div>
              ) : null
              ...
              return index <= displayedLines ? (
                <div key={index} className="terminal-line">
                  <div className="links">
                    <a href="https://linkedin.com/in/patricklerner" target="_blank" rel="noopener noreferrer" className="link">
                      linkedin.com
                    </a>
                    <a href="https://github.com/patricklerner" target="_blank" rel="noopener noreferrer" className="link">
                      github.com
                    </a>
                    <a href="https://instagram.com/ptlerner" target="_blank" rel="noopener noreferrer" className="link">
                      instagram.com
                    </a>
                    <a href="https://t.me/ptlerner" target="_blank" rel="noopener noreferrer" className="link">
                      t.me
                    </a>
                  </div>
                </div>
